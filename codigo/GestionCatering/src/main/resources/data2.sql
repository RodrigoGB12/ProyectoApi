...
INSERT INTO articulos_menu (nombre, descripcion, precio, imagen_nombre) VALUES
('Paella Valenciana', 'Arroz con mariscos, pollo y verduras', 12.50, 'paella_valenciana.jpg'),
('Tacos de Pescado', 'Tacos con pescado frito y salsa picante', 9.99, 'tacos_pescado.jpg'),
('Hamburguesa Clásica', 'Carne de res, pan de hamburguesa y condimentos', 8.50, 'hamburguesa_clasica.jpg'),
('Sopa de Mariscos', 'Sopa con camarones, almejas y calamares', 10.00, 'sopa_mariscos.jpg'),
('Pizza Margarita', 'Pizza con tomate, mozzarella y albahaca', 7.50, 'pizza_margarita.jpg'),
('Ensalada César', 'Lechuga, pollo a la parrilla, aderezo César', 6.99, 'ensalada_cesar.jpg'),
('Sushi Roll', 'Rollos de sushi con atún y aguacate', 14.00, 'sushi_roll.jpg'),
('Spaghetti Carbonara', 'Pasta con salsa de huevo y panceta', 11.00, 'spaghetti_carbonara.jpg'),
('Risotto de Setas', 'Risotto cremoso con setas frescas', 13.50, 'risotto_setas.jpg'),
('Costillas a la Barbacoa', 'Costillas de cerdo con salsa barbacoa', 15.00, 'costillas_barbacoa.jpg'),
('Pollo al Curry', 'Pollo cocinado con salsa de curry y arroz', 12.00, 'pollo_curry.jpg'),
('Tarta de Queso', 'Tarta dulce de queso con mermelada de frutos rojos', 5.50, 'tarta_queso.jpg'),
('Brownie de Chocolate', 'Pastel de chocolate con nueces', 4.75, 'brownie_chocolate.jpg'),
('Ensalada Caprese', 'Tomate, mozzarella y albahaca con aceite de oliva', 7.25, 'ensalada_caprese.jpg'),
('Ceviche de Pescado', 'Pescado marinado con jugo de limón y cebolla morada', 10.50, 'ceviche_pescado.jpg'),
('Croquetas de Jamón', 'Croquetas rellenas de jamón y bechamel', 5.00, 'croquetas_jamon.jpg'),
('Papas Fritas', 'Papas fritas crujientes con sal', 3.00, 'papas_fritas.jpg'),
('Gambas a la Plancha', 'Gambas cocinadas a la parrilla con aceite de oliva', 12.00, 'gambas_plancha.jpg'),
('Tarta de Limón', 'Tarta refrescante de limón con base de galleta', 5.00, 'tarta_limon.jpg'),
('Pudin de Chía', 'Pudin saludable de semillas de chía con leche de almendras', 4.50, 'pudin_chia.jpg');
